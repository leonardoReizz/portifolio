  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div
          ref={orbitRef}
          className="w-[600px] h-[600px] md:w-[800px] md:h-[800px] rounded-full border border-white/[0.03] animate-spin-slow"
        >
      ...
      <div className="container relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="animate-fade-up" style={{ animationDelay: "0.3s" }}>
            <span className="block text-5xl md:text-7xl lg:text-[5.5rem] font-bold tracking-tight leading-[1.05]">
              Leonardo Reis
            </span>
          </h1>
          ...
          {/* Typing text */}
          <div
            className="mt-6 mb-10 h-10 flex items-center justify-center animate-fade-in"
          ...
          {/* Description */}
          <p
            className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed mb-12 animate-fade-up"
          ...
          >
            <Button
              size="lg"
              className="glow-button rounded-full px-8 font-medium text-sm"
              asChild
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="rounded-full px-8 font-medium text-sm border-white/[0.08] bg-white/[0.02] hover:bg-white/[0.06] hover:border-white/[0.15] transition-all duration-500"
              asChild
            >
